...
def test_torch_blank_jpg(mock_yolov5_face_torch_model, mock_0_faces_image):
    model = mock_yolov5_face_torch_model
...
def test_onnx_blank_jpg(mock_yolov5_face_torch_model, mock_0_faces_image):
    model = mock_yolov5_face_torch_model
    fpath, _ = mock_0_faces_image
...
def test_torch_3_faces_jpg(mock_yolov5_face_onnx_model, mock_3_faces_image):
    model = mock_yolov5_face_onnx_model
...
def test_onnx_3_faces_jpg(mock_yolov5_face_onnx_model, mock_3_faces_image):
    model = mock_yolov5_face_onnx_model
    fpath, _ = mock_3_faces_image
