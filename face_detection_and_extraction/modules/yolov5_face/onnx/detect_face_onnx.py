...
from onnx_utils import disp_output, preprocess_image, conv_strides_to_anchors
...
def detect_onnx(img_path,
    ...
    model_input = preprocess_image(cv2_img, in_size=(in_w, in_h))
...
def parse_arguments(desc):
    ...
    parser.add_argument('-ox', '--onnx_path',
                        default="weights/yolov5s/yolov5s-face.onnx",  type=str,
