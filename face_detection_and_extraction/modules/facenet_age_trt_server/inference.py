...
sys.path.append(".")
from modules.facenet_age_trt_server.triton_utils import FlagConfig, get_client_and_model_metadata_config
from modules.facenet_age_trt_server.triton_utils import parse_model_grpc, get_inference_responses
...
class TritonServerInferenceSession(object):
    ...
    def __init__(self,
                 model_name="facenet_age",
                 container_name="facenet_age_ctn",
        ...
        docker.build("modules/facenet_age_trt_server/",
                     tags="facenet_age_net:latest")
        ...
        self.container = docker.run(image="facenet_age_net:latest", name=container_name,
...
if __name__ == "__main__":
    ...
    inf.container.kill()
    print("facenet age out shape", out.shape)
